                ...
                <tr key={emp._id} className="group hover:bg-white/5 transition-colors">
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-[#EEF3FB] flex items-center justify-center text-[#2F5DAA] font-bold text-xs">
                        {emp.name?.charAt(0)}
                      </div>
                  ...
                  <td className="px-6 py-4 text-[#6B7FA3] text-xs uppercase tracking-widest">{emp.department?.name || 'N/A'}</td>
                  <td className="px-6 py-4 text-[#6B7FA3] text-xs uppercase tracking-widest">{emp.designation?.name || 'N/A'}</td>
                  <td className="px-6 py-4 text-center">
                    <div className="flex justify-center gap-3">
                      <button
                        onClick={() => handleOpenModal(emp)}
                        className="text-[#6B7FA3] hover:text-[#0A1F44] transition-colors p-2"
                      >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>
                      </button>
                      <button
                        onClick={() => handleDelete(emp._id)}
                        className="text-[#6B7FA3] hover:text-red-500 transition-colors p-2"
                      >
