    ...
    <main className="min-h-screen bg-white flex">
      <div className="hidden lg:flex lg:w-1/2 bg-[#0A1F44] relative overflow-hidden flex-col items-center justify-center p-16">
        ...
        <div className="relative z-10 text-center">
          <div className="text-[10px] font-bold tracking-[0.4em] uppercase text-white/40 mb-6">Enterprise Access Portal</div>
          <h2 className="text-5xl font-black text-white leading-tight tracking-tight mb-4">VISITOR<br/>PASS</h2>
          <div className="w-12 h-px bg-white/20 mx-auto my-6"/>
          <p className="text-white/50 text-sm leading-relaxed max-w-xs">Secure, intelligent visitor management for modern enterprises.</p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="mb-10">
            <Link href="/">
              <img src="/vts-logo.png" alt="VISITORPASS" className="h-10 w-auto object-contain mb-6" style={{ width: 'auto' }} />
            </Link>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <button type="submit" disabled={loading} className="btn-vp-primary w-full py-4 text-sm justify-center mt-2">
              {loading ? 'Signing in...' : 'Sign In →'}
            </button>
          </form>

          <div className="mt-8 pt-6 border-t border-[#E2E8F0] text-center">
            <Link href="/" className="text-xs text-[#6B7FA3] hover:text-[#0A1F44] transition-colors">← Back to Home</Link>
          </div>
        </div>
      </div>
    </main>
